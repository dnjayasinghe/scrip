...
HD_PWD='/home/darshana/newlowrisc/lowrisc-chip/fpga/board/sasebo/ip_repo/edit_myip_v1_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log myip_v1_1.vds -m64 -mode batch -messageDb vivado.pb -notrace -source myip_v1_1.tcl
